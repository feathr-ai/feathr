 ...
 *
 * Our URNs all consist of an "entity type", which denotes an internal namespace for the resource,
 * as well as an entity key, formatted as a tuple of parts.  The full format of a URN is:
 * <p>
 *   &lt;URN> ::= urn:&lt;namespace>:&lt;entityType>:&lt;entityKey>
 * <p>
 * <a href="https://iwww.corp.linkedin.com/wiki/cf/display/ENGS/URN+syntax">URN syntax</a>
 *
 * <p>
 * The entity key is represented as a tuple of strings.  If the tuple is of length 1, the
 ...
 *
 * <p>
 *  urn:li:example:(1,2,3)
 */
public class Urn {
  /**
   *
   * @deprecated Don't create the Urn string manually, use Typed Urns or {@link #create(String entityType, Object... tupleParts)}
   */
  @Deprecated
  ...
  protected Urn(String namespace, String entityType, TupleKey entityKey, String stringValue) {
    _namespace = namespace;
    _entityType = entityType;
    _entityKey = entityKey;
    _cachedStringUrn = stringValue;
  }
  ...
  /**
   * DEPRECATED - use {@link #createFromTuple(String, Collection)}
   * Create a Urn from an entity type and a sequence of key parts.  The key parts are converted
   * to a tuple using @see TupleKey#create
   *
   * @param entityType - the entity type for the Urn
