...
class TestTimeBasedJoin extends TestFeathr {
  ...
  def testStartEndDatePath(): Unit = {
    ...
    val pathList11 = getPathList(inputData1.sourceType, inputData1.inputPath, ss, inputData1.dateParam)
  ...
  def testStartEndDatePathWithNoFailOnMissing(): Unit = {
    ...
    val pathList11 = getPathList(inputData1.sourceType, inputData1.inputPath, ss, inputData1.dateParam, None, false)
    val actualPathList =
  ...
  def testOffsetDatePath(): Unit = {
    ...
    val pathList33 = getPathList(inputData3.sourceType, inputData3.inputPath, ss, inputData3.dateParam)

    val pathList44 = getPathList(inputData4.sourceType, inputData4.inputPath, ss, inputData4.dateParam)
  ...
  def testOffsetDatePathRelatedToObs(): Unit = {
    ...
    val pathListRelative =
      getPathList(featureDataRelative.sourceType, featureDataRelative.inputPath, ss, featureDataRelative.dateParam, Some(observationStartDate))
    val pathListRelative2 = getPathList(featureDataRelative2.sourceType, featureDataRelative2.inputPath, ss, featureDataRelative2.dateParam)
    ...
    val pathListSpecific =
      getPathList(featureDataSpecific.sourceType, featureDataSpecific.inputPath, ss, featureDataSpecific.dateParam, Some(observationStartDate))
    val pathListSpecific2 = getPathList(featureDataSpecific.sourceType, featureDataSpecific.inputPath, ss, featureDataSpecific.dateParam)
  ...
  def testFixedPathList(): Unit = {
    ...
    val pathList22 = getPathList(inputData2.sourceType, inputData2.inputPath, ss, inputData2.dateParam)
  ...
  def testWrongTimeParam1(): Unit = {
    ...
    getPathList(inputData5.sourceType, inputData5.inputPath, ss, inputData5.dateParam)
  }
  ...
  def testWrongTimeParam2(): Unit = {
    ...
    val conf = new Configuration()
    // this should throw an exception
    getPathList(inputData6.sourceType, inputData6.inputPath, ss, inputData6.dateParam)
  }
  ...
  def testWrongTimeParam3(): Unit = {
    ...
    val conf = new Configuration()
    // this should throw an exception
    getPathList(inputData7.sourceType, inputData7.inputPath, ss, inputData7.dateParam)
  }
  ...
  def testWrongTimeParam4(): Unit = {
    ...
    val conf = new Configuration()
    // this should throw an exception
    getPathList(inputData8.sourceType, inputData8.inputPath, ss, inputData8.dateParam)
  }
}