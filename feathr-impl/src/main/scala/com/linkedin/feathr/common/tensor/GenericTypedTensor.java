...
public class GenericTypedTensor implements TypedTensor {
  ...
  private static final UnsupportedOperationException UNSUPPORTED_OPERATION_EXCEPTION =
      new UnsupportedOperationException("PROML-xxxx");
  ...
  /**
   * Select subslice along 1st dimension. Returns tensor with N-1 dimensions.
   */
  @Override
  public TypedTensor subSlice(final Object val) {
    throw UNSUPPORTED_OPERATION_EXCEPTION;
  }
