...
public class TypesafeConfigBuilderTest {
  ...
  public void testFeatureDefConfigFromResource1() {
    try {
      ...
      assertEquals(obsFeatureDef1ConfigObj, TypesafeFixture.expFeatureDef1ConfigObj);
  ...
  public void testFeatureDefConfigFromResource2() {
    try {
      ...
      assertEquals(obsFeatureDef2ConfigObj, TypesafeFixture.expFeatureDef2ConfigObj);
