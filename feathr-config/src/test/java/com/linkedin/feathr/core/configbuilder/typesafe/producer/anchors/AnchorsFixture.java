...
public class AnchorsFixture {
  ...
  static {
    ...
    features.put("member_lixSegment_isStudent", new SimpleFeatureConfig("is_student"));
    features.put("member_lixSegment_isJobSeeker", new SimpleFeatureConfig("job_seeker_class == 'active'"));
  ...
  static{
    ...
    TypedKey TypedKey = new TypedKey("\"memberId\"", ExprType.MVEL);
    String defaultValue = "0";
    ComplexFeatureConfig feature1 = new ComplexFeatureConfig("toNumeric(numIgnoredRejectedInvites)",
        ExprType.MVEL, defaultValue, expectedFeatureTypeConfig);
    ComplexFeatureConfig feature2= new ComplexFeatureConfig("toNumeric(numGuestInvites)",
        ExprType.MVEL, defaultValue, expectedFeatureTypeConfig);
    Map<String, FeatureConfig> features = new HashMap<>();
  ...
  static{
    ...
    Map<String, FeatureConfig> features = new HashMap<>();
    features.put("waterloo_job_jobTitle", new SimpleFeatureConfig("waterloo_job_jobTitle", featureTypeConfig));
    features.put("waterloo_job_companyId", new SimpleFeatureConfig("waterloo_job_companyId"));
    features.put("waterloo_job_companySize", new SimpleFeatureConfig("waterloo_job_companySize"));
  ...
  static final String anchor5ConfigStr = String.join("\n",
      ...
      "  transformer: \"com.linkedin.careers.relevance.frame.offline.anchor.LegacyFeastFormattedFeatures\"",
      "  features: [",
  ...
  static{
    ...
    String extractor = "com.linkedin.careers.relevance.frame.offline.anchor.LegacyFeastFormattedFeatures";
    Map<String, FeatureConfig> features = new HashMap<>();
    features.put("careers_member_degree", new SimpleFeatureConfig("careers_member_degree"));
    features.put("careers_member_rolledUpDegree", new SimpleFeatureConfig("careers_member_rolledUpDegree"));
    features.put("careers_member_fieldOfStudy", new SimpleFeatureConfig("careers_member_fieldOfStudy"));
  ...
  static{
    ...
    ComplexFeatureConfig feature = new ComplexFeatureConfig(featureExpr, featureTypeConfig);
    Map<String, FeatureConfig> features = new HashMap<>();
  ...
  static {
    ...
    TypedKey TypedKey = new TypedKey("\"substring(memberUrn, 15)\"", ExprType.MVEL);
  ...
  static{
    String source = "/jobs/frame/inlab/data/features/InvitationStats";
    String defaultValue = "0";
    ComplexFeatureConfig feature1 = new ComplexFeatureConfig("numIgnoredRejectedInvites",
        ExprType.SQL, null, defaultValue);
    ComplexFeatureConfig feature2= new ComplexFeatureConfig("numGuestInvites",
        ExprType.SQL,null, defaultValue);
    Map<String, FeatureConfig> features = new HashMap<>();
    ...
    expAnchor12ConfigObj = new AnchorConfigWithKey(source, new TypedKey("\"memberId\"", ExprType.SQL), null, features);
  }
  ...
  static{
    ...
    String extractor = "com.linkedin.frameproto.foundation.anchor.NiceJobFeatures";
    Map<String, FeatureConfig> features = new HashMap<>();
    features.put("waterloo_job_jobTitleV2", new SimpleFeatureConfig("waterloo_job_jobTitleV2"));
    features.put("waterloo_job_companyIdV2", new SimpleFeatureConfig("waterloo_job_companyIdV2"));
    features.put("waterloo_job_companySizeV2", new SimpleFeatureConfig("waterloo_job_companySizeV2"));
  ...
  static{
    ...
    String extractor = "com.linkedin.frameproto.foundation.anchor.NiceJobFeatures";
    Map<String, FeatureConfig> features = new HashMap<>();
    features.put("waterloo_job_jobTitleV2", new SimpleFeatureConfig(
