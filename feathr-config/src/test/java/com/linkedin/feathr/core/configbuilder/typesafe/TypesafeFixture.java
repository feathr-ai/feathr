...
class TypesafeFixture {
  ...
  static {
    ...
    expFeatureDef1ConfigObj = new FeatureDefConfig(null, anchorsConfigObj, null, null, null);
  }
  ...
  static {
    ...
    anchors.put("member-lix-segment", expAnchor1ConfigObj);
    AnchorsConfig anchorsConfigObj = new AnchorsConfig(anchors);
    expFeatureDef2ConfigObj = new FeatureDefConfig(sourcesConfigObj, anchorsConfigObj, null, null, null);
  }
}
