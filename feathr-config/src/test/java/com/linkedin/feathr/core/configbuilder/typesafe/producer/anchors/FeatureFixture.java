...
class FeatureFixture {
  ...
  static {
    ...
    expFeature1ConfigObj.put("member_lixSegment_isStudent", new SimpleFeatureConfig("is_student"));
    expFeature1ConfigObj.put(
        "member_lixSegment_isJobSeeker", new SimpleFeatureConfig("job_seeker_class == 'active'"));
  }
  ...
  static {
    ...
    expFeature1ConfigObjWithSpecialChars.put("member:lixSegment.isStudent", new SimpleFeatureConfig("is_student"));
    expFeature1ConfigObjWithSpecialChars.put(
        "member:lixSegment.isJobSeeker", new SimpleFeatureConfig("job_seeker_class == 'active'"));
  }
  ...
  static {
    ...
    expFeature2ConfigObj.put("waterloo_job_jobTitle", new SimpleFeatureConfig("waterloo_job_jobTitle"));
    expFeature2ConfigObj.put("waterloo_job_companyId", new SimpleFeatureConfig("waterloo_job_companyId"));
    expFeature2ConfigObj.put("waterloo_job_companySize", new SimpleFeatureConfig("waterloo_job_companySize"));
    expFeature2ConfigObj.put("waterloo_job_companyDesc", new SimpleFeatureConfig("waterloo_job_companyDesc"));
  }
  ...
  static {
    ...
    expFeature2WithTypeConfigObj.put("waterloo_job_jobTitle",
        new SimpleFeatureConfig("waterloo_job_jobTitle", featureTypeConfig));
    expFeature2WithTypeConfigObj.put("waterloo_job_companyId",
        new SimpleFeatureConfig("waterloo_job_companyId", featureTypeConfig, "true", Collections.emptyMap()));
    expFeature2WithTypeConfigObj.put("waterloo_job_companySize", new SimpleFeatureConfig("waterloo_job_companySize"));
    expFeature2WithTypeConfigObj.put("waterloo_job_companyDesc", new SimpleFeatureConfig("waterloo_job_companyDesc"));
  }
  ...
  static {
    ...
    ComplexFeatureConfig feature3= new ComplexFeatureConfig("toNumeric(numMemberInvites)", null);
  ...
  static {
    ...
    expFeature5WithTypeConfigObj.put("waterloo_job_jobTitleV2",
        new SimpleFeatureConfig("waterloo_job_jobTitleV2", new FeatureTypeConfig(FeatureType.BOOLEAN), "true", parameters));
  }
}
