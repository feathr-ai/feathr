package com.linkedin.frame.core.configvalidator;
...
import static com.linkedin.frame.core.config.ConfigType.*;
import static com.linkedin.frame.core.configvalidator.ConfigValidatorFixture.*;
...
public class ConfigValidatorTest {
  ...
  public void testConfigWithInvalidHocon() {
    List<String> configStrings = Arrays.asList(invalidHoconStr1, invalidHoconStr2);
  ...
  public void testFeatureDefConfigWithValidSyntax() {
    ...
    try (ConfigDataProvider cdp = new StringConfigDataProvider(validFeatureDefConfig)) {
      ValidationResult obsResult = _validator.validate(FeatureDef, SYNTACTIC, cdp);
  ...
  public void testFeatureDefConfigWithInvalidSyntax() {
    try (ConfigDataProvider cdp = new StringConfigDataProvider(invalidFeatureDefConfig)) {
      ValidationResult obsResult = _validator.validate(FeatureDef, SYNTACTIC, cdp);
  ...
  public void testJoinConfigWithValidSyntax() {
    List<String> configStrings = Arrays.asList(validJoinConfigWithSingleFeatureBag, validJoinConfigWithMultFeatureBags);
  ...
  public void testJoinConfigWithInvalidSyntax() {
    try (ConfigDataProvider cdp = new StringConfigDataProvider(invalidJoinConfig)) {
      ValidationResult obsResult = _validator.validate(Join, SYNTACTIC, cdp);
  ...
  public void testFeatureDefAndJoinConfigSyntax() {
    ...
    try (ConfigDataProvider featureDefCdp = new StringConfigDataProvider(validFeatureDefConfig);
        ConfigDataProvider joinCdp = new StringConfigDataProvider(validJoinConfigWithSingleFeatureBag)
    ) {
