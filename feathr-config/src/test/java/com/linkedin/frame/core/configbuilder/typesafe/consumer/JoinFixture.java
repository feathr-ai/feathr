package com.linkedin.frame.core.configbuilder.typesafe.consumer;

import com.linkedin.frame.core.config.consumer.AbsoluteTimeRangeConfig;
import com.linkedin.frame.core.config.consumer.DateTimeRange;
import com.linkedin.frame.core.config.consumer.FeatureBagConfig;
import com.linkedin.frame.core.config.consumer.JoinConfig;
import com.linkedin.frame.core.config.consumer.JoinTimeSettingsConfig;
import com.linkedin.frame.core.config.consumer.KeyedFeatures;
import com.linkedin.frame.core.config.consumer.ObservationDataTimeSettingsConfig;
import com.linkedin.frame.core.config.consumer.RelativeTimeRangeConfig;
import com.linkedin.frame.core.config.consumer.SettingsConfig;
import com.linkedin.frame.core.config.consumer.TimestampColumnConfig;
...
public class JoinFixture {
 ...
 null, relativeTimeRangeConfig);
  ...
  static {
    ...
    List<String> key = Collections.singletonList("memberId");
    ...
    List<String> key5 = Collections.singletonList("memberId");
