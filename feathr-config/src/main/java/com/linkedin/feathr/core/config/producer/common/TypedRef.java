...
import static com.linkedin.feathr.core.utils.Utils.require;
...
public class TypedRef implements Serializable {
  ...
  TypedRef(String namespace, String name, int major, int minor) {
    Utils.require(name != null, "Name of referenced object can't be null");
  ...
  TypedRef(Namespace parentNamespace, String refString) {
    ...
    if (matcher.matches()) {
      ...
      Utils.require(_name != null, "Name can't be null in the typed reference " + refString);

      String majorString = matcher.group(MAJOR);
      String minorString = matcher.group(MINOR);
      Utils.require((majorString != null) == (minorString != null), "Expected either both major and minor versions or "
