...
import com.linkedin.feathr.exception.FrameConfigException;
  ...
  ValidationResult validate(FeatureDefConfig featureDefConfig) {
    ...
    try {
      ...
      if (_withFeatureReachableValidation) {
        ...
        Set<String> unreachableFeatures = featureAccessInfo.getOrDefault(FeatureReachType.UNREACHABLE, Collections.emptySet());
