...
public class Version implements Serializable {
  ...
  public Version(int major, int minor) {
    Utils.require(major >= 0 && minor >= 0, "Expected version number to be >= 0, found " + major + "." + minor);
  ...
  public Version(String versionString) {
    ...
    Utils.require(versionParts.length == 2, "Expected version format major.minor, found " + versionString);

    _major = Integer.parseInt(versionParts[0]);
    _minor = Integer.parseInt(versionParts[1]);

    Utils.require(_major >= 0 && _minor >= 0, "Expected version number to be >= 0, found " + versionString);
  }
