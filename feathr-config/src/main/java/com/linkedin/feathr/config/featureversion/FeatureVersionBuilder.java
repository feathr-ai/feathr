package com.linkedin.feathr.config.featureversion;
...
import com.linkedin.feathr.config.featureversion.builder.TensorFeatureFormatBuilder;
...
public class FeatureVersionBuilder {
  ...
  public FeatureVersion build(@Nonnull DerivationConfig derivationConfig) {
    ...
    // TODO(PROML-11565) add default value support for derived feature
    return featureVersion;
  }
}
