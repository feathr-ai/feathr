...
import static com.linkedin.frame.core.config.producer.anchors.LateralViewParams.LATERAL_VIEW_DEF;
import static com.linkedin.frame.core.config.producer.anchors.LateralViewParams.LATERAL_VIEW_ITEM_ALIAS;
import static com.linkedin.frame.core.config.producer.anchors.LateralViewParams.LATERAL_VIEW_FILTER;


/**
 * Builds {@link LateralViewParams} object that are (optionally) used with
 * {@link com.linkedin.frame.core.config.producer.anchors.TimeWindowFeatureConfig} (aka sliding-window features)
 */
