...
import static com.linkedin.frame.core.config.producer.sources.SourceConfig.*;
...
class SourceConfigBuilder {
  private final static Logger logger = Logger.getLogger(SourceConfigBuilder.class);
