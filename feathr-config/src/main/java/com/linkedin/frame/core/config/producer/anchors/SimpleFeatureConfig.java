package com.linkedin.frame.core.config.producer.anchors;
 ...
 * }
 */
// TODO(PROML-17615): Rename this to ExtractorBasedFeatureConfig
...
public final class SimpleFeatureConfig extends FeatureConfig {
   ...
   */
  // TODO(PROML-17615): Remove this API in next major release
  ...
  // TODO(PROML-10384) Galene is using this function in their processing code so we can not update now. We can fix this
