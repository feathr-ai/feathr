...
/**
 * Interface for building {@link com.linkedin.frame.core.config.producer.FeatureDefConfig FeatureDefConfig} and
 * {@link com.linkedin.frame.core.config.consumer.JoinConfig JoinConfig}. Instance of a class implementing this
...
public interface ConfigBuilder {
   ...
   * @return {@link com.linkedin.frame.core.config.producer.FeatureDefConfig FeatureDefConfig} config object
   * @throws ConfigBuilderException
   * @deprecated Use {@link #buildFeatureDefConfig(ConfigDataProvider)} where
   * {@link com.linkedin.frame.core.configdataprovider.UrlConfigDataProvider UrlConfigDataProvider} can be used as a
   ...
   * @throws ConfigBuilderException
   * @deprecated Use {@link #buildFeatureDefConfig(ConfigDataProvider)} where
   * {@link com.linkedin.frame.core.configdataprovider.ResourceConfigDataProvider ResourceConfigDataProvider} can be
   ...
   * @throws ConfigBuilderException
   * @deprecated Use {@link #buildFeatureDefConfig(ConfigDataProvider)} where
   * {@link com.linkedin.frame.core.configdataprovider.StringConfigDataProvider StringConfigDataProvider}
   ...
   * @throws ConfigBuilderException
   * @deprecated Use {@link #buildFeatureDefConfig(ConfigDataProvider)} where
   * {@link com.linkedin.frame.core.configdataprovider.ReaderConfigDataProvider ReaderConfigDataProvider}
   * can be used as a {@link ConfigDataProvider}
   */
  @Deprecated
   ...
   * @throws ConfigBuilderException
   * @deprecated Use {@link #buildFeatureDefConfig(ConfigDataProvider)} where
   * {@link com.linkedin.frame.core.configdataprovider.ManifestConfigDataProvider ManifestConfigDataProvider}
   * can be used as a {@link ConfigDataProvider}
   */
  @Deprecated
   ...
   * @return {@link com.linkedin.frame.core.config.consumer.JoinConfig JoinConfig} config object
   * @throws ConfigBuilderException
   * @deprecated Use {@link #buildJoinConfig(ConfigDataProvider)} where
   * {@link com.linkedin.frame.core.configdataprovider.UrlConfigDataProvider UrlConfigDataProvider} can be used as
