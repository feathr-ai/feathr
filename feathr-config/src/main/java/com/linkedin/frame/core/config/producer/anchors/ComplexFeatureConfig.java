 ...
 * </pre>
 */
// TODO(PROML-17615): Rename this to ExpressionBasedFeatureConfigs
...
public final class ComplexFeatureConfig extends FeatureConfig {
   ...
   */
  // TODO(PROML-10369) Remove getFeatureType API in favor of getFeatureTypeConfig()
  @Deprecated
  ...
  private void constructConfigStr() {
    ...
    sb.append(FeatureConfig.DEF).append(": ").append(_featureExpr).append("\n");
