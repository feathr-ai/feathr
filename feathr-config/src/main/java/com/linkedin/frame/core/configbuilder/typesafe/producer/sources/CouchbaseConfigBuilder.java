...
import static com.linkedin.frame.core.config.producer.sources.CouchbaseConfig.*;
...
class CouchbaseConfigBuilder {
  private final static Logger logger = Logger.getLogger(CouchbaseConfigBuilder.class);
