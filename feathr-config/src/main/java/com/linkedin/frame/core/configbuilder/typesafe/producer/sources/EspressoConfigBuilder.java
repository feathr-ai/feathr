...
import static com.linkedin.frame.core.config.producer.sources.EspressoConfig.*;
...
class EspressoConfigBuilder {
  private final static Logger logger = Logger.getLogger(EspressoConfigBuilder.class);
