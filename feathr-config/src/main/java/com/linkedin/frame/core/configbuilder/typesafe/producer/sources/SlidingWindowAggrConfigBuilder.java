...
import com.linkedin.frame.core.config.producer.sources.SlidingWindowAggrConfig;
import com.linkedin.frame.core.config.producer.sources.TimeWindowParams;
import com.typesafe.config.Config;
import org.apache.log4j.Logger;

import static com.linkedin.frame.core.config.producer.sources.SlidingWindowAggrConfig.*;
...
class SlidingWindowAggrConfigBuilder {
  ...
  public static SlidingWindowAggrConfig build(Config sourceConfig) {
    ...
    if (timeWindowConfig.hasPath(LEGACY_TIMESTAMP_FIELD)) {
      // TODO(PROML-12604) we should remove the legacy fields after the users migrate to new syntax
