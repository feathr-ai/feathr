...
2. Click the button below to deploy a minimal set of Feathr resources for demo purpose. You will need to fill in the `Principal ID` and `Resource Prefix`.
...
3. Run the Feathr Jupyter Notebook by clicking the button below. You only need to fill in the specified `Resource Prefix`.
