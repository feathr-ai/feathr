    ...
    extends RecordTemplate
{
    ...
    public Window setSize(Integer value, SetMode mode) {
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field size of com.linkedin.feathr.compute.Window");
                } else {
    ...
    public Window setSize(
        ...
        Integer value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field size of com.linkedin.feathr.compute.Window to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "size", DataTemplateUtil.coerceIntInput(value));
            _sizeField = value;
        }
    ...
    public Window setUnit(Unit value, SetMode mode) {
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field unit of com.linkedin.feathr.compute.Window");
                } else {
    ...
    public Window setUnit(
        ...
        Unit value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field unit of com.linkedin.feathr.compute.Window to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "unit", value.name());
            _unitField = value;
        }
