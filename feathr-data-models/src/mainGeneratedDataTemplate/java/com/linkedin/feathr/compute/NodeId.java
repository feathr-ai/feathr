    ...
    extends TyperefInfo
{
    ...
    private final static TyperefDataSchema SCHEMA = ((TyperefDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.feathr.compute,typeref NodeId=int", SchemaFormatType.PDL));
