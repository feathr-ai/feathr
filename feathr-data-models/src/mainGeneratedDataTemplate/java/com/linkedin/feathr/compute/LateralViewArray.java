    ...
    extends WrappingArrayTemplate<LateralView>
{
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.feathr.compute.LateralView.Fields items() {
            return new com.linkedin.feathr.compute.LateralView.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.compute.LateralView.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public LateralViewArray.ProjectionMask withItems(Function<com.linkedin.feathr.compute.LateralView.ProjectionMask, com.linkedin.feathr.compute.LateralView.ProjectionMask> nestedMask) {
