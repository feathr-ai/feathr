    ...
    extends RecordTemplate
{
    ...
    private CustomDataSource _sourceField = null;
    private CustomDataSourceAnchor.ChangeListener __changeListener = new CustomDataSourceAnchor.ChangeListener(this);
    ...
    public CustomDataSourceAnchor() {
        super(new DataMap(4, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public CustomDataSourceAnchor(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static CustomDataSourceAnchor.Fields fields() {
        return _fields;
    }

    public static CustomDataSourceAnchor.ProjectionMask createMask() {
        return new CustomDataSourceAnchor.ProjectionMask();
    }
     ...
     * 
     * @see CustomDataSourceAnchor.Fields#transformationFunction
     */
     ...
     * @see CustomDataSourceAnchor.Fields#transformationFunction
     */
    public CustomDataSourceAnchor setTransformationFunction(com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setTransformationFunction(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field transformationFunction of com.linkedin.feathr.featureDataModel.CustomDataSourceAnchor");
                } else {
     ...
     * @see CustomDataSourceAnchor.Fields#transformationFunction
     */
    public CustomDataSourceAnchor setTransformationFunction(
        @Nonnull
        com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field transformationFunction of com.linkedin.feathr.featureDataModel.CustomDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "transformationFunction", value.data());
            _transformationFunctionField = value;
        }
     ...
     * 
     * @see CustomDataSourceAnchor.Fields#keyPlaceholders
     */
     ...
     * @see CustomDataSourceAnchor.Fields#keyPlaceholders
     */
    public CustomDataSourceAnchor setKeyPlaceholders(KeyPlaceholderArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setKeyPlaceholders(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field keyPlaceholders of com.linkedin.feathr.featureDataModel.CustomDataSourceAnchor");
                } else {
     ...
     * @see CustomDataSourceAnchor.Fields#keyPlaceholders
     */
    public CustomDataSourceAnchor setKeyPlaceholders(
        @Nonnull
        KeyPlaceholderArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field keyPlaceholders of com.linkedin.feathr.featureDataModel.CustomDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "keyPlaceholders", value.data());
            _keyPlaceholdersField = value;
        }
     ...
     * 
     * @see CustomDataSourceAnchor.Fields#source
     */
     ...
     * @see CustomDataSourceAnchor.Fields#source
     */
    public CustomDataSource getSource(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getSource();
            case DEFAULT:
            case NULL:
                if (_sourceField!= null) {
                    ...
                    _sourceField = ((__rawValue == null)?null:new CustomDataSource(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
                    return _sourceField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public CustomDataSource getSource() {
        if (_sourceField!= null) {
            return _sourceField;
        } else {
            Object __rawValue = super._map.get("source");
     ...
     * @see CustomDataSourceAnchor.Fields#source
     */
    public CustomDataSourceAnchor setSource(CustomDataSource value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setSource(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field source of com.linkedin.feathr.featureDataModel.CustomDataSourceAnchor");
                } else {
     ...
     * @see CustomDataSourceAnchor.Fields#source
     */
    public CustomDataSourceAnchor setSource(
        @Nonnull
        CustomDataSource value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field source of com.linkedin.feathr.featureDataModel.CustomDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "source", value.data());
            _sourceField = value;
        }
    ...
    @Override
    public CustomDataSourceAnchor clone()
        throws CloneNotSupportedException
    {
        CustomDataSourceAnchor __clone = ((CustomDataSourceAnchor) super.clone());
        __clone.__changeListener = new CustomDataSourceAnchor.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public CustomDataSourceAnchor copy()
        throws CloneNotSupportedException
    {
        CustomDataSourceAnchor __copy = ((CustomDataSourceAnchor) super.copy());
        __copy._transformationFunctionField = null;
        __copy._keyPlaceholdersField = null;
        __copy._sourceField = null;
        __copy.__changeListener = new CustomDataSourceAnchor.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final CustomDataSourceAnchor __objectRef;

        private ChangeListener(CustomDataSourceAnchor reference) {
        ...
        extends PathSpec
    {
        ...
        /**
         * Defines a custom data source which uses user-defined data fetching mechanism. See CustomDataSource for more details.
         * 
         */
        public com.linkedin.feathr.featureDataModel.CustomDataSource.Fields source() {
            return new com.linkedin.feathr.featureDataModel.CustomDataSource.Fields(getPathComponents(), "source");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.featureDataModel.CustomDataSource.ProjectionMask _sourceMask;
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withTransformationFunction(Function<com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction.ProjectionMask, com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withTransformationFunction() {
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withKeyPlaceholders() {
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _keyPlaceholdersMask = nestedMask.apply(((_keyPlaceholdersMask == null)?KeyPlaceholderArray.createMask():_keyPlaceholdersMask));
            getDataMap().put("keyPlaceholders", _keyPlaceholdersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withKeyPlaceholders(Integer start, Integer count) {
            _keyPlaceholdersMask = null;
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.CustomDataSource.ProjectionMask, com.linkedin.feathr.featureDataModel.CustomDataSource.ProjectionMask> nestedMask) {
            _sourceMask = nestedMask.apply(((_sourceMask == null)?CustomDataSource.createMask():_sourceMask));
         ...
         * 
         */
        public CustomDataSourceAnchor.ProjectionMask withSource() {
            _sourceMask = null;
