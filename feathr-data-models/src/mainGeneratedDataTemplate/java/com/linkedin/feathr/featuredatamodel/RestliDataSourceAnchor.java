    ...
    extends RecordTemplate
{
    ...
    private RestliDataSource _sourceField = null;
    private RestliDataSourceAnchor.ChangeListener __changeListener = new RestliDataSourceAnchor.ChangeListener(this);
    ...
    public RestliDataSourceAnchor() {
        super(new DataMap(4, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public RestliDataSourceAnchor(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static RestliDataSourceAnchor.Fields fields() {
        return _fields;
    }

    public static RestliDataSourceAnchor.ProjectionMask createMask() {
        return new RestliDataSourceAnchor.ProjectionMask();
    }
     ...
     * 
     * @see RestliDataSourceAnchor.Fields#transformationFunction
     */
     ...
     * @see RestliDataSourceAnchor.Fields#transformationFunction
     */
    public RestliDataSourceAnchor setTransformationFunction(com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setTransformationFunction(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field transformationFunction of com.linkedin.feathr.featureDataModel.RestliDataSourceAnchor");
                } else {
     ...
     * @see RestliDataSourceAnchor.Fields#transformationFunction
     */
    public RestliDataSourceAnchor setTransformationFunction(
        @Nonnull
        com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field transformationFunction of com.linkedin.feathr.featureDataModel.RestliDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "transformationFunction", value.data());
            _transformationFunctionField = value;
        }
     ...
     * 
     * @see RestliDataSourceAnchor.Fields#keyPlaceholders
     */
     ...
     * @see RestliDataSourceAnchor.Fields#keyPlaceholders
     */
    public RestliDataSourceAnchor setKeyPlaceholders(KeyPlaceholderArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setKeyPlaceholders(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field keyPlaceholders of com.linkedin.feathr.featureDataModel.RestliDataSourceAnchor");
                } else {
     ...
     * @see RestliDataSourceAnchor.Fields#keyPlaceholders
     */
    public RestliDataSourceAnchor setKeyPlaceholders(
        @Nonnull
        KeyPlaceholderArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field keyPlaceholders of com.linkedin.feathr.featureDataModel.RestliDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "keyPlaceholders", value.data());
            _keyPlaceholdersField = value;
        }
     ...
     * 
     * @see RestliDataSourceAnchor.Fields#source
     */
     ...
     * @see RestliDataSourceAnchor.Fields#source
     */
    public RestliDataSource getSource(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getSource();
            case DEFAULT:
            case NULL:
                if (_sourceField!= null) {
                    ...
                    _sourceField = ((__rawValue == null)?null:new RestliDataSource(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
                    return _sourceField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public RestliDataSource getSource() {
        if (_sourceField!= null) {
            return _sourceField;
        } else {
            Object __rawValue = super._map.get("source");
     ...
     * @see RestliDataSourceAnchor.Fields#source
     */
    public RestliDataSourceAnchor setSource(RestliDataSource value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setSource(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field source of com.linkedin.feathr.featureDataModel.RestliDataSourceAnchor");
                } else {
     ...
     * @see RestliDataSourceAnchor.Fields#source
     */
    public RestliDataSourceAnchor setSource(
        @Nonnull
        RestliDataSource value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field source of com.linkedin.feathr.featureDataModel.RestliDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "source", value.data());
            _sourceField = value;
        }
    ...
    @Override
    public RestliDataSourceAnchor clone()
        throws CloneNotSupportedException
    {
        RestliDataSourceAnchor __clone = ((RestliDataSourceAnchor) super.clone());
        __clone.__changeListener = new RestliDataSourceAnchor.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public RestliDataSourceAnchor copy()
        throws CloneNotSupportedException
    {
        RestliDataSourceAnchor __copy = ((RestliDataSourceAnchor) super.copy());
        __copy._transformationFunctionField = null;
        __copy._keyPlaceholdersField = null;
        __copy._sourceField = null;
        __copy.__changeListener = new RestliDataSourceAnchor.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final RestliDataSourceAnchor __objectRef;

        private ChangeListener(RestliDataSourceAnchor reference) {
        ...
        extends PathSpec
    {
        ...
        /**
         * Defines a Rest.li data source, in which source data is fetched by the primary key of the Rest.li resource. See RestliDataSource for more details.
         * 
         */
        public com.linkedin.feathr.featureDataModel.RestliDataSource.Fields source() {
            return new com.linkedin.feathr.featureDataModel.RestliDataSource.Fields(getPathComponents(), "source");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.featureDataModel.RestliDataSource.ProjectionMask _sourceMask;
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withTransformationFunction() {
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withKeyPlaceholders() {
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _keyPlaceholdersMask = nestedMask.apply(((_keyPlaceholdersMask == null)?KeyPlaceholderArray.createMask():_keyPlaceholdersMask));
            getDataMap().put("keyPlaceholders", _keyPlaceholdersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withKeyPlaceholders(Integer start, Integer count) {
            _keyPlaceholdersMask = null;
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.RestliDataSource.ProjectionMask, com.linkedin.feathr.featureDataModel.RestliDataSource.ProjectionMask> nestedMask) {
            _sourceMask = nestedMask.apply(((_sourceMask == null)?RestliDataSource.createMask():_sourceMask));
         ...
         * 
         */
        public RestliDataSourceAnchor.ProjectionMask withSource() {
            _sourceMask = null;
