    ...
    extends RecordTemplate
{
    ...
    public CrossEnvironmentFeatureSourcesAnchor() {
        super(new DataMap(4, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public CrossEnvironmentFeatureSourcesAnchor(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static CrossEnvironmentFeatureSourcesAnchor.Fields fields() {
        return _fields;
    }

    public static CrossEnvironmentFeatureSourcesAnchor.ProjectionMask createMask() {
        return new CrossEnvironmentFeatureSourcesAnchor.ProjectionMask();
    }
     ...
     * 
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#keyPlaceholders
     */
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#keyPlaceholders
     */
    public CrossEnvironmentFeatureSourcesAnchor setKeyPlaceholders(KeyPlaceholderArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setKeyPlaceholders(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field keyPlaceholders of com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor");
                } else {
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#keyPlaceholders
     */
    public CrossEnvironmentFeatureSourcesAnchor setKeyPlaceholders(
        @Nonnull
        KeyPlaceholderArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field keyPlaceholders of com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "keyPlaceholders", value.data());
            _keyPlaceholdersField = value;
        }
     ...
     * 
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#source
     */
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#source
     */
    public CrossEnvironmentFeatureSourcesAnchor setSource(FeatureSourceArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setSource(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field source of com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor");
                } else {
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#source
     */
    public CrossEnvironmentFeatureSourcesAnchor setSource(
        @Nonnull
        FeatureSourceArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field source of com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "source", value.data());
            _sourceField = value;
        }
     ...
     * 
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#transformationFunction
     */
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#transformationFunction
     */
    public CrossEnvironmentFeatureSourcesAnchor.TransformationFunction getTransformationFunction(GetMode mode) {
        switch (mode) {
            case STRICT:
            ...
            case NULL:
                if (_transformationFunctionField!= null) {
                    ...
                    _transformationFunctionField = ((__rawValue == null)?null:new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction(__rawValue));
                    return _transformationFunctionField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public CrossEnvironmentFeatureSourcesAnchor.TransformationFunction getTransformationFunction() {
        if (_transformationFunctionField!= null) {
            return _transformationFunctionField;
        } else {
            Object __rawValue = super._map.get("transformationFunction");
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#transformationFunction
     */
    public CrossEnvironmentFeatureSourcesAnchor setTransformationFunction(CrossEnvironmentFeatureSourcesAnchor.TransformationFunction value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setTransformationFunction(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field transformationFunction of com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor");
                } else {
     ...
     * @see CrossEnvironmentFeatureSourcesAnchor.Fields#transformationFunction
     */
    public CrossEnvironmentFeatureSourcesAnchor setTransformationFunction(
        @Nonnull
        CrossEnvironmentFeatureSourcesAnchor.TransformationFunction value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field transformationFunction of com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "transformationFunction", value.data());
            _transformationFunctionField = value;
        }
    ...
    @Override
    public CrossEnvironmentFeatureSourcesAnchor clone()
        throws CloneNotSupportedException
    {
        CrossEnvironmentFeatureSourcesAnchor __clone = ((CrossEnvironmentFeatureSourcesAnchor) super.clone());
        __clone.__changeListener = new CrossEnvironmentFeatureSourcesAnchor.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public CrossEnvironmentFeatureSourcesAnchor copy()
        throws CloneNotSupportedException
    {
        CrossEnvironmentFeatureSourcesAnchor __copy = ((CrossEnvironmentFeatureSourcesAnchor) super.copy());
        __copy._transformationFunctionField = null;
        __copy._keyPlaceholdersField = null;
        __copy._sourceField = null;
        __copy.__changeListener = new CrossEnvironmentFeatureSourcesAnchor.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final CrossEnvironmentFeatureSourcesAnchor __objectRef;

        private ChangeListener(CrossEnvironmentFeatureSourcesAnchor reference) {
        ...
        extends PathSpec
    {
        ...
        /**
         * Defines the supported transformation logic uniformly across all environments (eg. MVEL) to produce feature value from feature sources.
         * 
         */
        public com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.Fields transformationFunction() {
            return new com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.Fields(getPathComponents(), "transformationFunction");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ProjectionMask _transformationFunctionMask;
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withKeyPlaceholders() {
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _keyPlaceholdersMask = nestedMask.apply(((_keyPlaceholdersMask == null)?KeyPlaceholderArray.createMask():_keyPlaceholdersMask));
            getDataMap().put("keyPlaceholders", _keyPlaceholdersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withKeyPlaceholders(Integer start, Integer count) {
            _keyPlaceholdersMask = null;
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.FeatureSourceArray.ProjectionMask, com.linkedin.feathr.featureDataModel.FeatureSourceArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withSource() {
            _sourceMask = null;
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.FeatureSourceArray.ProjectionMask, com.linkedin.feathr.featureDataModel.FeatureSourceArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _sourceMask = nestedMask.apply(((_sourceMask == null)?FeatureSourceArray.createMask():_sourceMask));
            getDataMap().put("source", _sourceMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withSource(Integer start, Integer count) {
            _sourceMask = null;
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withTransformationFunction(Function<com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ProjectionMask, com.linkedin.feathr.featureDataModel.CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ProjectionMask> nestedMask) {
            _transformationFunctionMask = nestedMask.apply(((_transformationFunctionMask == null)?CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.createMask():_transformationFunctionMask));
         ...
         * 
         */
        public CrossEnvironmentFeatureSourcesAnchor.ProjectionMask withTransformationFunction() {
        ...
        extends UnionTemplate
    {
        ...
        private CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ChangeListener __changeListener = new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ChangeListener(this);
        ...
        public static CrossEnvironmentFeatureSourcesAnchor.TransformationFunction create(com.linkedin.feathr.featureDataModel.MvelExpression value) {
            CrossEnvironmentFeatureSourcesAnchor.TransformationFunction newUnion = new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction();
        ...
        public static CrossEnvironmentFeatureSourcesAnchor.TransformationFunction create(com.linkedin.feathr.featureDataModel.UnspecifiedTransformationFunction value) {
            CrossEnvironmentFeatureSourcesAnchor.TransformationFunction newUnion = new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction();
        ...
        public static CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ProjectionMask createMask() {
            return new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ProjectionMask();
        }

        @Override
        public CrossEnvironmentFeatureSourcesAnchor.TransformationFunction clone()
            throws CloneNotSupportedException
        {
            CrossEnvironmentFeatureSourcesAnchor.TransformationFunction __clone = ((CrossEnvironmentFeatureSourcesAnchor.TransformationFunction) super.clone());
            __clone.__changeListener = new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ChangeListener(__clone);
            __clone.addChangeListener(__clone.__changeListener);
            return __clone;
        }

        @Override
        public CrossEnvironmentFeatureSourcesAnchor.TransformationFunction copy()
            throws CloneNotSupportedException
        {
            CrossEnvironmentFeatureSourcesAnchor.TransformationFunction __copy = ((CrossEnvironmentFeatureSourcesAnchor.TransformationFunction) super.copy());
            __copy._mvelExpressionMember = null;
            __copy._unspecifiedTransformationFunctionMember = null;
            __copy.__changeListener = new CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ChangeListener(__copy);
            __copy.addChangeListener(__copy.__changeListener);
            return __copy;
        }
            ...
            implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
        {
            ...
            private final CrossEnvironmentFeatureSourcesAnchor.TransformationFunction __objectRef;

            private ChangeListener(CrossEnvironmentFeatureSourcesAnchor.TransformationFunction reference) {
                __objectRef = reference;
            }
            ...
            extends MaskMap
        {
            ...
            public CrossEnvironmentFeatureSourcesAnchor.TransformationFunction.ProjectionMask withMvelExpression(Function<com.linkedin.feathr.featureDataModel.MvelExpression.ProjectionMask, com.linkedin.feathr.featureDataModel.MvelExpression.ProjectionMask> nestedMask) {
