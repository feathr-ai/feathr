    ...
    extends RecordTemplate
{
    ...
    private CouchbaseDataSource _sourceField = null;
    private CouchbaseDataSourceAnchor.ChangeListener __changeListener = new CouchbaseDataSourceAnchor.ChangeListener(this);
    ...
    public CouchbaseDataSourceAnchor() {
        super(new DataMap(4, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public CouchbaseDataSourceAnchor(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static CouchbaseDataSourceAnchor.Fields fields() {
        return _fields;
    }

    public static CouchbaseDataSourceAnchor.ProjectionMask createMask() {
        return new CouchbaseDataSourceAnchor.ProjectionMask();
    }
     ...
     * 
     * @see CouchbaseDataSourceAnchor.Fields#transformationFunction
     */
     ...
     * @see CouchbaseDataSourceAnchor.Fields#transformationFunction
     */
    public CouchbaseDataSourceAnchor setTransformationFunction(com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setTransformationFunction(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field transformationFunction of com.linkedin.feathr.featureDataModel.CouchbaseDataSourceAnchor");
                } else {
     ...
     * @see CouchbaseDataSourceAnchor.Fields#transformationFunction
     */
    public CouchbaseDataSourceAnchor setTransformationFunction(
        @Nonnull
        com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field transformationFunction of com.linkedin.feathr.featureDataModel.CouchbaseDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "transformationFunction", value.data());
            _transformationFunctionField = value;
        }
     ...
     * 
     * @see CouchbaseDataSourceAnchor.Fields#keyPlaceholders
     */
     ...
     * @see CouchbaseDataSourceAnchor.Fields#keyPlaceholders
     */
    public CouchbaseDataSourceAnchor setKeyPlaceholders(KeyPlaceholderArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setKeyPlaceholders(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field keyPlaceholders of com.linkedin.feathr.featureDataModel.CouchbaseDataSourceAnchor");
                } else {
     ...
     * @see CouchbaseDataSourceAnchor.Fields#keyPlaceholders
     */
    public CouchbaseDataSourceAnchor setKeyPlaceholders(
        @Nonnull
        KeyPlaceholderArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field keyPlaceholders of com.linkedin.feathr.featureDataModel.CouchbaseDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "keyPlaceholders", value.data());
            _keyPlaceholdersField = value;
        }
     ...
     * 
     * @see CouchbaseDataSourceAnchor.Fields#source
     */
     ...
     * @see CouchbaseDataSourceAnchor.Fields#source
     */
    public CouchbaseDataSource getSource(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getSource();
            case DEFAULT:
            case NULL:
                if (_sourceField!= null) {
                    ...
                    _sourceField = ((__rawValue == null)?null:new CouchbaseDataSource(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
                    return _sourceField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public CouchbaseDataSource getSource() {
        if (_sourceField!= null) {
            return _sourceField;
        } else {
            Object __rawValue = super._map.get("source");
     ...
     * @see CouchbaseDataSourceAnchor.Fields#source
     */
    public CouchbaseDataSourceAnchor setSource(CouchbaseDataSource value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setSource(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field source of com.linkedin.feathr.featureDataModel.CouchbaseDataSourceAnchor");
                } else {
     ...
     * @see CouchbaseDataSourceAnchor.Fields#source
     */
    public CouchbaseDataSourceAnchor setSource(
        @Nonnull
        CouchbaseDataSource value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field source of com.linkedin.feathr.featureDataModel.CouchbaseDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "source", value.data());
            _sourceField = value;
        }
    ...
    @Override
    public CouchbaseDataSourceAnchor clone()
        throws CloneNotSupportedException
    {
        CouchbaseDataSourceAnchor __clone = ((CouchbaseDataSourceAnchor) super.clone());
        __clone.__changeListener = new CouchbaseDataSourceAnchor.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public CouchbaseDataSourceAnchor copy()
        throws CloneNotSupportedException
    {
        CouchbaseDataSourceAnchor __copy = ((CouchbaseDataSourceAnchor) super.copy());
        __copy._transformationFunctionField = null;
        __copy._keyPlaceholdersField = null;
        __copy._sourceField = null;
        __copy.__changeListener = new CouchbaseDataSourceAnchor.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final CouchbaseDataSourceAnchor __objectRef;

        private ChangeListener(CouchbaseDataSourceAnchor reference) {
        ...
        extends PathSpec
    {
        ...
        /**
         * Defines a Couchbase data source. Couchbase is a distributed key-value caching solution. See CouchbaseDataSource for more details.
         * 
         */
        public com.linkedin.feathr.featureDataModel.CouchbaseDataSource.Fields source() {
            return new com.linkedin.feathr.featureDataModel.CouchbaseDataSource.Fields(getPathComponents(), "source");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.featureDataModel.CouchbaseDataSource.ProjectionMask _sourceMask;
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withTransformationFunction() {
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withKeyPlaceholders() {
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _keyPlaceholdersMask = nestedMask.apply(((_keyPlaceholdersMask == null)?KeyPlaceholderArray.createMask():_keyPlaceholdersMask));
            getDataMap().put("keyPlaceholders", _keyPlaceholdersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withKeyPlaceholders(Integer start, Integer count) {
            _keyPlaceholdersMask = null;
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.CouchbaseDataSource.ProjectionMask, com.linkedin.feathr.featureDataModel.CouchbaseDataSource.ProjectionMask> nestedMask) {
            _sourceMask = nestedMask.apply(((_sourceMask == null)?CouchbaseDataSource.createMask():_sourceMask));
         ...
         * 
         */
        public CouchbaseDataSourceAnchor.ProjectionMask withSource() {
            _sourceMask = null;
