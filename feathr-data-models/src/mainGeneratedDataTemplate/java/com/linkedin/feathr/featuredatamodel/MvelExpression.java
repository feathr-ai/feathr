 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from feathr-data-models/src/main/pegasus/com/linkedin/feathr/featureDataModel/MvelExpression.pdl.")
public class MvelExpression
    extends RecordTemplate
{

    private final static MvelExpression.Fields _fields = new MvelExpression.Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.feathr.featureDataModel/**An expression in MVEL language. For more information please refer to go/framemvel.*/record MvelExpression{/**The MVEL expression.*/mvel:string}", SchemaFormatType.PDL));
    ...
    public MvelExpression setMvel(String value, SetMode mode) {
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field mvel of com.linkedin.feathr.featureDataModel.MvelExpression");
                } else {
    ...
    public MvelExpression setMvel(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field mvel of com.linkedin.feathr.featureDataModel.MvelExpression to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "mvel", value);
            _mvelField = value;
        }
