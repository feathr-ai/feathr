    ...
    extends RecordTemplate
{
    ...
    private VeniceDataSource _sourceField = null;
    private VeniceDataSourceAnchor.ChangeListener __changeListener = new VeniceDataSourceAnchor.ChangeListener(this);
    ...
    public VeniceDataSourceAnchor() {
        super(new DataMap(4, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public VeniceDataSourceAnchor(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static VeniceDataSourceAnchor.Fields fields() {
        return _fields;
    }

    public static VeniceDataSourceAnchor.ProjectionMask createMask() {
        return new VeniceDataSourceAnchor.ProjectionMask();
    }
     ...
     * 
     * @see VeniceDataSourceAnchor.Fields#transformationFunction
     */
     ...
     * @see VeniceDataSourceAnchor.Fields#transformationFunction
     */
    public VeniceDataSourceAnchor setTransformationFunction(com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setTransformationFunction(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field transformationFunction of com.linkedin.feathr.featureDataModel.VeniceDataSourceAnchor");
                } else {
     ...
     * @see VeniceDataSourceAnchor.Fields#transformationFunction
     */
    public VeniceDataSourceAnchor setTransformationFunction(
        @Nonnull
        com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field transformationFunction of com.linkedin.feathr.featureDataModel.VeniceDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "transformationFunction", value.data());
            _transformationFunctionField = value;
        }
     ...
     * 
     * @see VeniceDataSourceAnchor.Fields#keyPlaceholders
     */
     ...
     * @see VeniceDataSourceAnchor.Fields#keyPlaceholders
     */
    public VeniceDataSourceAnchor setKeyPlaceholders(KeyPlaceholderArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setKeyPlaceholders(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field keyPlaceholders of com.linkedin.feathr.featureDataModel.VeniceDataSourceAnchor");
                } else {
     ...
     * @see VeniceDataSourceAnchor.Fields#keyPlaceholders
     */
    public VeniceDataSourceAnchor setKeyPlaceholders(
        @Nonnull
        KeyPlaceholderArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field keyPlaceholders of com.linkedin.feathr.featureDataModel.VeniceDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "keyPlaceholders", value.data());
            _keyPlaceholdersField = value;
        }
     ...
     * 
     * @see VeniceDataSourceAnchor.Fields#source
     */
     ...
     * @see VeniceDataSourceAnchor.Fields#source
     */
    public VeniceDataSource getSource(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getSource();
            case DEFAULT:
            case NULL:
                if (_sourceField!= null) {
                    ...
                    _sourceField = ((__rawValue == null)?null:new VeniceDataSource(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
                    return _sourceField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public VeniceDataSource getSource() {
        if (_sourceField!= null) {
            return _sourceField;
        } else {
            Object __rawValue = super._map.get("source");
     ...
     * @see VeniceDataSourceAnchor.Fields#source
     */
    public VeniceDataSourceAnchor setSource(VeniceDataSource value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setSource(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field source of com.linkedin.feathr.featureDataModel.VeniceDataSourceAnchor");
                } else {
     ...
     * @see VeniceDataSourceAnchor.Fields#source
     */
    public VeniceDataSourceAnchor setSource(
        @Nonnull
        VeniceDataSource value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field source of com.linkedin.feathr.featureDataModel.VeniceDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "source", value.data());
            _sourceField = value;
        }
    ...
    @Override
    public VeniceDataSourceAnchor clone()
        throws CloneNotSupportedException
    {
        VeniceDataSourceAnchor __clone = ((VeniceDataSourceAnchor) super.clone());
        __clone.__changeListener = new VeniceDataSourceAnchor.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public VeniceDataSourceAnchor copy()
        throws CloneNotSupportedException
    {
        VeniceDataSourceAnchor __copy = ((VeniceDataSourceAnchor) super.copy());
        __copy._transformationFunctionField = null;
        __copy._keyPlaceholdersField = null;
        __copy._sourceField = null;
        __copy.__changeListener = new VeniceDataSourceAnchor.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final VeniceDataSourceAnchor __objectRef;

        private ChangeListener(VeniceDataSourceAnchor reference) {
        ...
        extends PathSpec
    {
        ...
        /**
         * Defines a Venice data source. Venice is a data store for derived data. See VeniceDataSource for more details.
         * 
         */
        public com.linkedin.feathr.featureDataModel.VeniceDataSource.Fields source() {
            return new com.linkedin.feathr.featureDataModel.VeniceDataSource.Fields(getPathComponents(), "source");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.featureDataModel.VeniceDataSource.ProjectionMask _sourceMask;
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withTransformationFunction() {
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withKeyPlaceholders() {
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _keyPlaceholdersMask = nestedMask.apply(((_keyPlaceholdersMask == null)?KeyPlaceholderArray.createMask():_keyPlaceholdersMask));
            getDataMap().put("keyPlaceholders", _keyPlaceholdersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withKeyPlaceholders(Integer start, Integer count) {
            _keyPlaceholdersMask = null;
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.VeniceDataSource.ProjectionMask, com.linkedin.feathr.featureDataModel.VeniceDataSource.ProjectionMask> nestedMask) {
            _sourceMask = nestedMask.apply(((_sourceMask == null)?VeniceDataSource.createMask():_sourceMask));
         ...
         * 
         */
        public VeniceDataSourceAnchor.ProjectionMask withSource() {
            _sourceMask = null;
