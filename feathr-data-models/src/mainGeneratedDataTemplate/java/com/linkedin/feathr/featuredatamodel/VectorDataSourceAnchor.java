    ...
    extends RecordTemplate
{
    ...
    private VectorDataSource _sourceField = null;
    private VectorDataSourceAnchor.ChangeListener __changeListener = new VectorDataSourceAnchor.ChangeListener(this);
    ...
    public VectorDataSourceAnchor() {
        super(new DataMap(4, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public VectorDataSourceAnchor(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static VectorDataSourceAnchor.Fields fields() {
        return _fields;
    }

    public static VectorDataSourceAnchor.ProjectionMask createMask() {
        return new VectorDataSourceAnchor.ProjectionMask();
    }
     ...
     * 
     * @see VectorDataSourceAnchor.Fields#transformationFunction
     */
     ...
     * @see VectorDataSourceAnchor.Fields#transformationFunction
     */
    public VectorDataSourceAnchor setTransformationFunction(com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setTransformationFunction(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field transformationFunction of com.linkedin.feathr.featureDataModel.VectorDataSourceAnchor");
                } else {
     ...
     * @see VectorDataSourceAnchor.Fields#transformationFunction
     */
    public VectorDataSourceAnchor setTransformationFunction(
        @Nonnull
        com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field transformationFunction of com.linkedin.feathr.featureDataModel.VectorDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "transformationFunction", value.data());
            _transformationFunctionField = value;
        }
     ...
     * 
     * @see VectorDataSourceAnchor.Fields#keyPlaceholders
     */
     ...
     * @see VectorDataSourceAnchor.Fields#keyPlaceholders
     */
    public VectorDataSourceAnchor setKeyPlaceholders(KeyPlaceholderArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setKeyPlaceholders(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field keyPlaceholders of com.linkedin.feathr.featureDataModel.VectorDataSourceAnchor");
                } else {
     ...
     * @see VectorDataSourceAnchor.Fields#keyPlaceholders
     */
    public VectorDataSourceAnchor setKeyPlaceholders(
        @Nonnull
        KeyPlaceholderArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field keyPlaceholders of com.linkedin.feathr.featureDataModel.VectorDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "keyPlaceholders", value.data());
            _keyPlaceholdersField = value;
        }
     ...
     * 
     * @see VectorDataSourceAnchor.Fields#source
     */
     ...
     * @see VectorDataSourceAnchor.Fields#source
     */
    public VectorDataSource getSource(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getSource();
            case DEFAULT:
            case NULL:
                if (_sourceField!= null) {
                    ...
                    _sourceField = ((__rawValue == null)?null:new VectorDataSource(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
                    return _sourceField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public VectorDataSource getSource() {
        if (_sourceField!= null) {
            return _sourceField;
        } else {
            Object __rawValue = super._map.get("source");
     ...
     * @see VectorDataSourceAnchor.Fields#source
     */
    public VectorDataSourceAnchor setSource(VectorDataSource value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setSource(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field source of com.linkedin.feathr.featureDataModel.VectorDataSourceAnchor");
                } else {
     ...
     * @see VectorDataSourceAnchor.Fields#source
     */
    public VectorDataSourceAnchor setSource(
        @Nonnull
        VectorDataSource value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field source of com.linkedin.feathr.featureDataModel.VectorDataSourceAnchor to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "source", value.data());
            _sourceField = value;
        }
    ...
    @Override
    public VectorDataSourceAnchor clone()
        throws CloneNotSupportedException
    {
        VectorDataSourceAnchor __clone = ((VectorDataSourceAnchor) super.clone());
        __clone.__changeListener = new VectorDataSourceAnchor.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public VectorDataSourceAnchor copy()
        throws CloneNotSupportedException
    {
        VectorDataSourceAnchor __copy = ((VectorDataSourceAnchor) super.copy());
        __copy._transformationFunctionField = null;
        __copy._keyPlaceholdersField = null;
        __copy._sourceField = null;
        __copy.__changeListener = new VectorDataSourceAnchor.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final VectorDataSourceAnchor __objectRef;

        private ChangeListener(VectorDataSourceAnchor reference) {
        ...
        extends PathSpec
    {
        ...
        /**
         * Defines a Vector data source, in which source data is fetched by assetUrn + featureSourceName via Restli unstructured
         * data endpoint.
         * 
         */
        public com.linkedin.feathr.featureDataModel.VectorDataSource.Fields source() {
            return new com.linkedin.feathr.featureDataModel.VectorDataSource.Fields(getPathComponents(), "source");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.feathr.featureDataModel.VectorDataSource.ProjectionMask _sourceMask;
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withTransformationFunction(Function<com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction.ProjectionMask, com.linkedin.feathr.featureDataModel.TransformationFunctionForOnlineDataSource.TransformationFunction.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withTransformationFunction() {
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withKeyPlaceholders() {
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withKeyPlaceholders(Function<com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask, com.linkedin.feathr.featureDataModel.KeyPlaceholderArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _keyPlaceholdersMask = nestedMask.apply(((_keyPlaceholdersMask == null)?KeyPlaceholderArray.createMask():_keyPlaceholdersMask));
            getDataMap().put("keyPlaceholders", _keyPlaceholdersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withKeyPlaceholders(Integer start, Integer count) {
            _keyPlaceholdersMask = null;
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withSource(Function<com.linkedin.feathr.featureDataModel.VectorDataSource.ProjectionMask, com.linkedin.feathr.featureDataModel.VectorDataSource.ProjectionMask> nestedMask) {
            _sourceMask = nestedMask.apply(((_sourceMask == null)?VectorDataSource.createMask():_sourceMask));
         ...
         * 
         */
        public VectorDataSourceAnchor.ProjectionMask withSource() {
            _sourceMask = null;
