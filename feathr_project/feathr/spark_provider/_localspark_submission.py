...
from feathr.version import get_maven_artifact
...
class _FeathrLocalSparkJobLauncher(SparkJobLauncher):
    ...
    def submit_feathr_job(
        ...
        **_,
        ...
        maven_dependency = f"{cfg.pop('spark.jars.packages', self.packages)},{get_maven_artifact()}"
        ...
        if not main_jar_path:
            ...
            if not python_files:
                ...
                logger.info(f"Main JAR file is not set, using default package '{get_maven_artifact()}' from Maven")
