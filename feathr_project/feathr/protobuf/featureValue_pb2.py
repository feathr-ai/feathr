...
BooleanArray = _reflection.GeneratedProtocolMessageType(
    "BooleanArray",
    (_message.Message,),
    {
...
IntegerArray = _reflection.GeneratedProtocolMessageType(
    "IntegerArray",
    (_message.Message,),
    {
...
BytesArray = _reflection.GeneratedProtocolMessageType(
    "BytesArray",
    (_message.Message,),
    {
...
SparseStringArray = _reflection.GeneratedProtocolMessageType(
    "SparseStringArray",
    (_message.Message,),
    {
...
SparseBoolArray = _reflection.GeneratedProtocolMessageType(
    "SparseBoolArray",
    (_message.Message,),
    {
...
SparseIntegerArray = _reflection.GeneratedProtocolMessageType(
    "SparseIntegerArray",
    (_message.Message,),
    {
...
SparseLongArray = _reflection.GeneratedProtocolMessageType(
    "SparseLongArray",
    (_message.Message,),
    {
...
SparseDoubleArray = _reflection.GeneratedProtocolMessageType(
    "SparseDoubleArray",
    (_message.Message,),
    {
...
SparseFloatArray = _reflection.GeneratedProtocolMessageType(
    "SparseFloatArray",
    (_message.Message,),
    {
