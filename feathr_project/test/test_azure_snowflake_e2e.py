...
def test_feathr_online_store_agg_features():
    ...
    settings = MaterializationSettings(
        ...
        sinks=[redisSink],
        feature_names=["f_snowflake_call_center_division_name", "f_snowflake_call_center_zipcode"],
    ...
    res = client.get_online_features(
        online_test_table, "1", ["f_snowflake_call_center_division_name", "f_snowflake_call_center_zipcode"]
    )
    ...
    res = client.multi_get_online_features(
        online_test_table, ["1", "2"], ["f_snowflake_call_center_division_name", "f_snowflake_call_center_zipcode"]
    )
    assert res["1"][0] != None
    assert res["1"][1] != None
    assert res["2"][0] != None
...
def test_feathr_get_offline_features():
    ...
    feature_query = FeatureQuery(
        feature_list=["f_snowflake_call_center_division_name", "f_snowflake_call_center_zipcode"], key=call_sk_id
    )
