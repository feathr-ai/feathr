...
def test_feathr_materialize_with_time_partition_pattern_hourly():
    ...
    client: FeathrClient = time_partition_pattern_feature_gen_test_setup(os.path.join(test_workspace_dir, "feathr_config.yaml"), source_path, source_path,local_workspace_dir="test_materialize_hourly", resolution='HOURLY')
...
def test_feathr_get_offline_with_time_partition_pattern_postfix_path():
    ...
    [client, feature_query, settings] = time_partition_pattern_feature_join_test_setup(os.path.join(test_workspace_dir, "feathr_config.yaml"), source_path, source_path,local_workspace_dir="test_offline_tpp",postfix_path='postfixPath')
