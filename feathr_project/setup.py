...
setup(
    ...
    # consider
    install_requires=[
        # packages below are not critical and we are using its basic functions, so any version should be fine
        "click",
        "py4j",
        "loguru",
        "pandas",
        ...
        "pyarrow",
        "python-snappy",
        # we do have some sort of requirements for the packages below. 
